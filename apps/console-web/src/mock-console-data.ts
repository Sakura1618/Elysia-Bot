...
export const mockConsoleData: ConsolePayload = {
  ...
  schedules: [
    {
      ...
      dueAtSource: 'sqlite-schedule-plans',
      dueAtEvidence: 'persisted dueAt restored from sqlite schedule plan state during runtime recovery',
      dueAtPersisted: true,
      dueReady: false,
      overdue: false,
      claimOwner: 'runtime-local:scheduler-loop',
      claimedAt: '2026-04-19T12:00:30Z',
      claimed: true,
      recoveryState: 'recovered-from-persisted-schedule-plan',
      dueStateSummary: 'claimed after due recovery',
      dueSummary: 'delay became due after restart recovery and was then claimed by the current scheduler loop',
      scheduleSummary: 'message.received | delay restored from persisted schedule plan, due at 2026-04-19T12:01:00Z, claimed by runtime-local:scheduler-loop',
  ...
  logs: [
    ...
    '2026-04-19T12:00:30Z INFO schedule-console recovered persisted dueAt and claimed by runtime-local:scheduler-loop',
  ],
  audits: [
    {
      actor: 'admin-user',
