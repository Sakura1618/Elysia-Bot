module github.com/ohmyopencode/bot-platform/tests/e2e
...
require (
	...
	github.com/ohmyopencode/bot-platform/plugins/plugin-scheduler v0.0.0
	github.com/ohmyopencode/bot-platform/plugins/plugin-template-smoke v0.0.0
)
...
replace github.com/ohmyopencode/bot-platform/plugins/plugin-scheduler => ../../plugins/plugin-scheduler

replace github.com/ohmyopencode/bot-platform/plugins/plugin-template-smoke => ../../plugins/plugin-template-smoke
